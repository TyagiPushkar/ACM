...
import AddConsignment from "../components/consignment/AddConsignment"
import ViewConsignment from "../components/consignment/ViewConsgnment"
...
function Consignment() {
  ...
  const renderContent = () => {
      if (currentPath.includes("/client-list")) {
          return <ConsignmentList />
      } else if (currentPath.includes("/add-consignment")) { 
        return <AddConsignment/>
      }
      else if (currentPath.includes("/view-consignment")) { 
        return <ViewConsignment/>
      }
    return <ConsignmentList /> // Default fallback
  }
